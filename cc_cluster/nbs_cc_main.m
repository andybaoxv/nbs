function [cc_cluster,W_list,H_list,sample_data,outlierVect] = ...    
...
% Please see license.txt for full details.
    ...
    for iC = 1:run_options.nsample
        ...
        % Run clustering
        [Tnet{iC},W{iC},H{iC},outlierVect{iC}] = cluster_data(gind_sample,gene_id_sample,znetwork,run_options,glapD);

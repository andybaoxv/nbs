function [t_cluster,W_list,H_list,outlierVect] = ...    
...
% Choose whether to use propagation(smoothing)
...
[t_cluster,W_list,H_list,outlierVect] = cluster_data(gind_mat,gene_id_gmap,znetwork,run_options,knnGlap);
